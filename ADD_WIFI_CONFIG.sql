...
-- Step 1: Add column (JSONB array for flexibility)
...
'JSON array of allowed WiFi SSID names for attendance. Empty array = allow all WiFi. AI validates detected WiFi against this list.';
