  ...
  return (
    <div className="ds-container space-y-6">
      <div className="bg-gradient-to-r from-slate-800 to-slate-700 rounded-2xl p-6 shadow-xl">
        <h1 className="ds-heading text-white flex items-center gap-3"><FaTerminal /> Admin Terminal (Whitelisted)</h1>
        <p className="ds-subtle text-slate-300 mt-1 text-sm">Jalankan command yang diizinkan. Hanya super_admin dan ALLOW_ADMIN_OPS=true.</p>
      </div>
      <TerminalRunner />
