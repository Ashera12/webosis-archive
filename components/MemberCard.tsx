        ...
        <div className="relative z-10">
          ...
          {member.instagram_username && (
            <a
              ...
              className="inline-flex items-center gap-2 text-sm text-pink-600 dark:text-pink-400 hover:text-pink-700 dark:hover:text-pink-300 transition-colors mb-4 group/ig"
            >
              ...
              <span className="group-hover/ig:underline">@{member.instagram_username}</span>
